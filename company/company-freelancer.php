	...
	<div class="container air">
		<div class="row air1">
			<div class="col-lg-6 air2 " data-toggle="modal" data-target="#req-rec-modal">
				...
				<div class="col-lg-6 air-right" data-toggle="modal" data-target="#req-rec-modal">
					<div class="trapezoi tp-color">
						<p class="m-0">Request Received</p>
					</div>
					<div class="row">
						<div class="col-lg-5 air3">
				...
				<div class="col-lg-6 air2 " data-toggle="modal" data-target="#req-sent-modal">
				...
				<div class="col-lg-6 air2 " data-toggle="modal" data-target="#req-match-modal">
		      ...
		      <div class="modal-content modal1">
				...
				<div class="modal-body">
				    ...
				    <div class="container request-me">
						...
						<div class="col-md-9  text-center btn-success border">
